        ...
        $('#deal-project').DataTable({
            ...
            "columns": [{
                ...
                },
                {
                    "render": function(data, type, row) {
                        if (row['tags'] == "0") {
                            var class_name = "badge-soft-secondary border-secondary";
                            var tags_name = "Rated"
                        } else if (row['tags'] == "1") {
                            var class_name = "badge-soft-success border-success";
                            var tags_name = "Collab"
                        } else if (row['status'] == "2") {
                            var class_name = "badge-soft-danger border-danger";
                            var tags_name = "Rejected"
                        } else {
                            var class_name = "badge-soft-purple border-purple";
                            var tags_name = "Promotion"
                        }
