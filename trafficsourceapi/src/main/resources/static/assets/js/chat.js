...
(function () {
    ...
    const CURRENT_USER_ID = resolveDevelopmentUserId();
    const API = '/api/chat';
    ...
    async function request(path, options = {}) {
        const config = { method: 'GET', ...options, headers: { Accept: 'application/json','X-Dev-User-Id': String(CURRENT_USER_ID), ...(options.headers || {}) } };
